...
-- =============================================
IF NOT EXISTS (SELECT 1 FROM [dbo].[UserPackages] WHERE [RemainingCredits] = 5)
BEGIN
    ...
    IF @TestUserId IS NOT NULL AND @SingaporePackageId IS NOT NULL
    BEGIN
        ...
        PRINT 'Test user packages created.';
    END
END
ELSE
BEGIN
...
-- Seed Test Classes
-- =============================================
IF NOT EXISTS (SELECT 1 FROM [dbo].[Classes] WHERE [Name] LIKE '%Test%')
BEGIN
